...
gauss_x1 = np.random.normal(loc=0.0, scale=1.0, size=20)
gauss_y1 = np.random.normal(loc=0.0, scale=1.0, size=20)
plt.scatter(gauss_x1, gauss_y1, color='blue')
gauss_x2 = np.random.normal(loc=5.0, scale=1.0, size=20)
gauss_y2 = np.random.normal(loc=5.0, scale=1.0, size=20)
plt.scatter(gauss_x2, gauss_y2, color='red')
gauss_x3 = np.random.normal(loc=10.0, scale=1.0, size=20)
gauss_y3 = np.random.normal(loc=10.0, scale=1.0, size=20)
plt.scatter(gauss_x3, gauss_y3, color='green')
gauss_x4 = np.random.normal(loc=0.0, scale=1.0, size=20)
gauss_y4 = np.random.normal(loc=10.0, scale=1.0, size=20)
plt.scatter(gauss_x4, gauss_y4, color='orange')
gauss_x5 = np.random.normal(loc=10.0, scale=1.0, size=20)
gauss_y5 = np.random.normal(loc=0.0, scale=1.0, size=20)
...
print("!!!!!! CENTER: ", gauss_1_predicted.cluster_centers_, "!!!!!")
...
for i in range(2, len(gauss_xall)):
    ...
    print("!!!!!! CENTER: ", gauss_i_predicted.cluster_centers_, "!!!!!")
...
gauss_100_predicted = KMeans(n_clusters=100)
gauss_100_predicted.fit_predict(gauss_all)
print("********** ", 100, " CLUSTER(S) **********")
print(gauss_100_predicted)
print("!!!!!! CENTER: ", gauss_100_predicted.cluster_centers_, "!!!!!")
inertia_list.append(gauss_100_predicted.inertia_)
print("Inertia: ", gauss_100_predicted.inertia_)
print("========================================")
print("")
...
for i in range(1, len(linear_inertia_points_list), 1):
    ...
    Relative_Gain_Coefficient = (linear_inertia_points_list[i] - plot_real_inertia_list[i]) / i
